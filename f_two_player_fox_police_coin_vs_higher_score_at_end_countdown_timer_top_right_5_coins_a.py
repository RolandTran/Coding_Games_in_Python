...
def draw():
    ...
    screen.draw.text(f"Fox Score: {score_fox} USD", color="black", topleft=(10, 10))
    screen.draw.text(f"Police Score: {score_police} USD", color="black", topleft=(10, 30))
    ...
    if game_over:
        screen.fill("pink")
        if winner == "fox":
            screen.draw.text(f"Fox Wins! {score_fox} USD.", topleft=(100, 200), fontsize=60, color="black")
        elif winner == "police":
            screen.draw.text(f"Police Wins! {score_police} USD.", topleft=(100, 200), fontsize=60, color="black")
        else:
