...
# ─── Sound setup ───────────────────────
hitapple = pygame.mixer.Sound("sounds/hitapple.wav")
hitpineapple = pygame.mixer.Sound("sounds/hitpineapple.wav")
hitorange = pygame.mixer.Sound("sounds/hitorange.wav")
